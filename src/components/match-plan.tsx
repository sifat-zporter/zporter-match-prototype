...
import { Camera, Video, Plus, List, ChevronUp, ChevronDown } from "lucide-react";
...
const PlayerOnPitch = ({ player }: { player: { name: string, number: number, rating: number, avatar: string } }) => (
    <div className="flex flex-col items-center justify-center gap-1 text-center">
        <div className="relative">
            ...
            <div className="absolute -top-1 -left-4 text-xs font-semibold">{player.rating}</div>
        ...
        <div className="space-y-4">
            <Tabs defaultValue="line-up">
                ...
                <TabsContent value="offense">
                    <p className="text-muted-foreground text-center p-8">Offense planning will be available here.</p>
                </TabsContent>
                <TabsContent value="defense">
                    <p className="text-muted-foreground text-center p-8">Defense planning will be available here.</p>
                </TabsContent>
            </Tabs>
        </div>
    );
