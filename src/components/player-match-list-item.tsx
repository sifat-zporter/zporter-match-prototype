// src/components/player-match-list-item.tsx
"use client";
...
interface PlayerMatchListItemProps {
  ...
  isFollowed: boolean;
  onFollowToggle: (playerId: string, isCurrentlyFollowed: boolean) => void;
}

export function PlayerMatchListItem({ matchPlayer, isFollowed, onFollowToggle }: PlayerMatchListItemProps) {
      ...
      <div className="p-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold">{matchPlayer.player.name}</span>
          </div>
          <div className="flex items-center gap-2">
             <Button
              variant="ghost"
              ...
              onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                  onFollowToggle(matchPlayer.player.id, isFollowed)
              }}
